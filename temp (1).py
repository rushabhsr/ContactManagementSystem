...
def Deletewindow():
    ...
    label1_delwin = Label(delwin,text="Enter Number:",font = "Calibri 10 ",bg='gray24',fg='thistle1' )
    label1_delwin.grid(row=1,sticky='E',column=0)
    
    global entry1_delwin
    global entry2_delwin

    entry1_delwin= Entry(delwin) 
    entry1_delwin.grid(row=0 , column=1)
    entry2_delwin= Entry(delwin) 
    entry2_delwin.grid(row=1 , column=1)
    
    button1_delwin = Button(delwin, text="Delete Name",command=DeleteContact,bg='gray40', font = "Calibri 10 bold ",fg='white',width=16,height=1)
    button1_delwin.grid(row=2, column= 0)
    ...
    button2_delwin.grid(row=3, column= 0)
    button3_delwin = Button(delwin, text="Delete Number",command=DeleteNumber,bg='gray40', font = "Calibri 10 bold ",fg='white',width=16,height=1)
    button3_delwin.grid(row=2, column= 1)
...
def Addwindow():
    ...
    label2_addwindow = Label(addwindow,text="Enter Number:",font = "Calibri 10 ",bg='gray24',fg='thistle1' )
